...
"""autogenerated by genpy from etsi_msgs/LongitudinalAcceleration.msg. Do not edit."""
import codecs
import sys
...
class LongitudinalAcceleration(genpy.Message):
  _md5sum = "1817cb5901a9c214183a59333522d9fb"
  _type = "etsi_msgs/LongitudinalAcceleration"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """int16 value # 0.1 m/s^2
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(LongitudinalAcceleration, self).__init__(*args, **kwds)
