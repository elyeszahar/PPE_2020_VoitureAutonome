...
class VehicleWidth {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new VehicleWidth(null);
  ...
  static datatype() {
    ...
    return 'etsi_msgs/VehicleWidth';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return 'e63c01375861937c95cc07a981f79e09';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new VehicleWidth(null);
...
VehicleWidth.Constants = {
  TEN_CENTIMETERS: 1,
  OUT_OF_RANGE: 61,
  UNAVAILABLE: 62,
}

module.exports = VehicleWidth;
