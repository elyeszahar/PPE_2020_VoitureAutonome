...
(cl:defmethod cl:initialize-instance :after ((m <Speed>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Speed)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ece_msgs-msg:<Speed> is deprecated: use ece_msgs-msg:Speed instead.")))
...
(cl:defmethod confidence-val ((m <Speed>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ece_msgs-msg:confidence-val is deprecated.  Use ece_msgs-msg:confidence instead.")
  (confidence m))
