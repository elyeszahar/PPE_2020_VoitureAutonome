...
(cl:defmethod cl:initialize-instance :after ((m <StationType>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'StationType)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name etsi_msgs-msg:<StationType> is deprecated: use etsi_msgs-msg:StationType instead.")))
