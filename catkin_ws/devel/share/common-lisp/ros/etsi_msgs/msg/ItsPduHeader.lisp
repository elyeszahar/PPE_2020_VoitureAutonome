...
(cl:defmethod cl:initialize-instance :after ((m <ItsPduHeader>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ItsPduHeader)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name etsi_msgs-msg:<ItsPduHeader> is deprecated: use etsi_msgs-msg:ItsPduHeader instead.")))

(cl:ensure-generic-function 'protocol_version-val :lambda-list '(m))
(cl:defmethod protocol_version-val ((m <ItsPduHeader>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader etsi_msgs-msg:protocol_version-val is deprecated.  Use etsi_msgs-msg:protocol_version instead.")
  (protocol_version m))

(cl:ensure-generic-function 'message_id-val :lambda-list '(m))
(cl:defmethod message_id-val ((m <ItsPduHeader>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader etsi_msgs-msg:message_id-val is deprecated.  Use etsi_msgs-msg:message_id instead.")
  (message_id m))
