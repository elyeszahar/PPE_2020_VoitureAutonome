...
(cl:defmethod cl:initialize-instance :after ((m <VehicleLength>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'VehicleLength)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name simu_msgs-msg:<VehicleLength> is deprecated: use simu_msgs-msg:VehicleLength instead.")))
...
(cl:defmethod confidence_indication-val ((m <VehicleLength>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simu_msgs-msg:confidence_indication-val is deprecated.  Use simu_msgs-msg:confidence_indication instead.")
