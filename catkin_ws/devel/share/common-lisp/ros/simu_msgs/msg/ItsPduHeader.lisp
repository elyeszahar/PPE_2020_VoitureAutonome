...
(cl:defmethod cl:initialize-instance :after ((m <ItsPduHeader>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ItsPduHeader)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name simu_msgs-msg:<ItsPduHeader> is deprecated: use simu_msgs-msg:ItsPduHeader instead.")))

(cl:ensure-generic-function 'protocol_version-val :lambda-list '(m))
(cl:defmethod protocol_version-val ((m <ItsPduHeader>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simu_msgs-msg:protocol_version-val is deprecated.  Use simu_msgs-msg:protocol_version instead.")
  (protocol_version m))

(cl:ensure-generic-function 'message_id-val :lambda-list '(m))
(cl:defmethod message_id-val ((m <ItsPduHeader>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simu_msgs-msg:message_id-val is deprecated.  Use simu_msgs-msg:message_id instead.")
  (message_id m))

(cl:ensure-generic-function 'station_id-val :lambda-list '(m))
(cl:defmethod station_id-val ((m <ItsPduHeader>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simu_msgs-msg:station_id-val is deprecated.  Use simu_msgs-msg:station_id instead.")
  (station_id m))
